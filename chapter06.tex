...
\indexaltsub{algoritmo}{goloso}
\indexaltsub{algoritmo}{ávido}
\indexaltsub{algoritmo}{devorador}
...
\index{codificación Huffman}

\subsubsection{Codificación Huffman}

La \key{codificación Huffman}\footnote{D. A. Huffman descubrió este método
