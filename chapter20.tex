...
En el problema del \key{corte mínimo}, nuestra tarea es quitar un
...
es la capacidad mínima en el camino. Además, el peso de cada arista en el
...
si resulta más efectivo dirigir el flujo de otra manera.
...
y cuyas capacidades son completamente utilizadas en el flujo máximo. En el
...
Ahora, definamos $X=\{2,4\}$ que resulta en $f(X)=\{7\}$:
...
en el grafo original (posiblemente a través de múltiples aristas).
...
anticadena que contenga tres nodos. Hemos visto anteriormente que
