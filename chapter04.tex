...
Toma nota de la asimetría en los iteradores:
...
Por ejemplo, si se almacenan $n$ bits en un arreglo de \texttt{int}s,
se utilizarán $32n$ bits de memoria, pero un bitset correspondiente
solo requiere $n$ bits de memoria. Además, los valores de un bitset
...
Una \key{cola} (\textit{queue}) también
