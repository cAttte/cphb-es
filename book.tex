...
\everyesindex{\esindexreplace{á}{\'a} \esindexreplace{é}{\'e} \esindexreplace{í}{\'i} \esindexreplace{ó}{\'o} \esindexreplace{ú}{\'u}}
\makeatletter \newcommand{\origindex}{\esx@trueindex} \makeatother % \esindex breaks italics
\newcommand{\indexalt}[1]{\origindex{#1@\textit{#1}}}
\newcommand{\indexaltsub}[2]{\origindex{#1!#2@\textit{#2}}}
